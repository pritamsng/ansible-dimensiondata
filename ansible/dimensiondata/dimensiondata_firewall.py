...
short_description:
    - Create, update, and delete MCP 1.0 & 2.0 firewall rules.
version_added: '2.1'
...
options:
  ...
  source_port:
    description:
      - Source any/all, single port or port range.
    default: any
  destination:
    description:
  ...
  source_port:
    description:
      - Destination any/all, single port or port range.
    default: any
  placement:
    description:
      - Placement of rule in relation to others.
      - One of First, Last, Before <rulename>, After <rulename>.
    default: last
  verify_ssl_cert:
    description:
